...
type ExampleClient interface {
	ServerReply(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloRespone, error)
}
...
func (c *exampleClient) ServerReply(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloRespone, error) {
	out := new(HelloRespone)
	err := c.cc.Invoke(ctx, Example_ServerReply_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ExampleServer interface {
	ServerReply(context.Context, *HelloRequest) (*HelloRespone, error)
...
func (UnimplementedExampleServer) ServerReply(context.Context, *HelloRequest) (*HelloRespone, error) {
