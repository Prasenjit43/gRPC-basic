...
type Example_ServerReplyClient interface {
	...
	CloseAndRecv() (*HelloRespone, error)
	grpc.ClientStream
}
...
func (x *exampleServerReplyClient) CloseAndRecv() (*HelloRespone, error) {
...
type Example_ServerReplyServer interface {
	SendAndClose(*HelloRespone) error
...
func (x *exampleServerReplyServer) SendAndClose(m *HelloRespone) error {
