...
func (x *exampleServerReplyClient) Recv() (*HelloRespone, error) {
	m := new(HelloRespone)
...
func (x *exampleServerReplyServer) Send(m *HelloRespone) error {
